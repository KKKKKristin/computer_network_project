...
#define BACKLOG 10
#define TCP_PORT "25591"
#define C_UDP_PORT "21591"
#define CS_UDP_PORT "22591"
#define EE_UDP_PORT "23591"
#define UDP_PORT "24591"
...
cout << "The main server received the result of the authentication request from ServerC using UDP over port " << UDP_PORT << "." << endl;
...
while (true) {
if(recv(tcp_child_socket, buf, MAXBUFSIZE, 0) <= 0) 
    break;
get_query_info(buf);
...
cout << "The main server received the response from serverCS using UDP over port " << UDP_PORT "." << endl;
...
cout << "The main server received the response from serverEE using UDP over port " << UDP_PORT "." << endl;
